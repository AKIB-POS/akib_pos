          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  const Padding(
                    ...
                    child: Text('Pengajuan Lembur', style: AppTextStyle.bigCaptionBold),
                  ),
                  const OvertimeRequestWidget(),
                  const SizedBox(height: 12,), // Display overtime requests
                  Container(
            ...
            const Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(left: 16, top: 16),
                  child: Text('Riwayat Lembur', style: AppTextStyle.bigCaptionBold),
                ),
