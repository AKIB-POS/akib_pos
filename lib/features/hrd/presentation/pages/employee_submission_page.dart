...
class EmployeeSubmissionPage extends StatefulWidget {
  const EmployeeSubmissionPage({super.key});

  @override
  _EmployeeSubmissionPageState createState() => _EmployeeSubmissionPageState();
}

class _EmployeeSubmissionPageState extends State<EmployeeSubmissionPage>
  ...
  void initState() {
    ...
    context
        .read<ApprovedSubmissionsCubit>()
        .fetchApprovedSubmissions(branchId: branchId);
    context
        .read<PendingSubmissionsCubit>()
        .fetchPendingSubmissions(branchId: branchId);
    context
        .read<RejectedSubmissionsCubit>()
        .fetchRejectedSubmissions(branchId: branchId);
  }
