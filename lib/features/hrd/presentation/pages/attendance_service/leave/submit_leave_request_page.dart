...
class _SubmitLeaveRequestPageState extends State<SubmitLeaveRequestPage> {
  ...
  //   final status = await _handleCameraPermission();
  ...
  //     // Tampilkan dialog meminta izin lagi jika izin ditolak
  ...
  // Future<PermissionStatus> _handleCameraPermission() async {
  ...
  //     SnackBar(
  //       content: const Text('Izin kamera diperlukan untuk mengambil gambar.'),
  //       action: SnackBarAction(
  //         label: 'Retry',
  //         onPressed: () {
  //           _pickImageFromCamera(); // Minta ulang izin kamera
  //         },
  //       ),
  //     ),
  //   );
  ...
  //     SnackBar(
  //       content: const Text(
  //           'Izin kamera ditolak secara permanen. Silakan aktifkan dari pengaturan.'),
  //       action: SnackBarAction(
  //         label: 'Settings',
  //         onPressed: () {
...
void _showPermanentDeniedDialog() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<SubmitLeaveRequestCubit, SubmitLeaveRequestState>(
                      ...
                      BlocBuilder<LeaveTypeCubit, LeaveTypeState>(
                        builder: (context, state) {
                          if (state is LeaveTypeLoading) {
                            ...
                            return Text(
                                'Gagal memuat data cuti: ${state.message}');
                          } else {
                            return Container();
                          }
                        },
